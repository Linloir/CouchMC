...
// App product
let productID = idFor("product", "CouchMC.app")
L("\t\(productID) /* CouchMC.app */ = {isa = PBXFileReference; explicitFileType = wrapper.application; includeInIndex = 0; path = CouchMC.app; sourceTree = BUILT_PRODUCTS_DIR; };")
...
L("\t\tproductReference = \(productID) /* CouchMC.app */;")
